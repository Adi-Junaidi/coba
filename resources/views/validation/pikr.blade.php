              ...
              <tr>
                ...
                <td>
                  ...
                  <form class="d-inline" action="/pikr/{{ $p->id }}/verify" method="post">
                    @csrf
                    @if ($p->verified)
                      <button class="btn btn-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" type="submit">Batalkan Verifikasi</button>
                    @else
                      <button class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" type="submit">Verifikasi PIK-R</button>
                    @endif
                  </form>
                </td>
              </tr>
