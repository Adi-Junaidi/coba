@extends('layouts.main', [
    'title' => 'Validasi Registrasi PIK-R',
    'heading' => 'Validasi Registrasi PIK-R',
    'breadcrumb' => ['Validasi', 'Registrasi PIK-R'],
])
          ...
          <tbody>
            @foreach ($pikr as $p)
              <tr>
                ...
                <td>
                  <button class="btn-show btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#showModal" data-id="{{ $p->id }}">Detail</button>

                  @if ($p->verified)
                    <form class="d-inline" action="/pikr/{{ $p->id }}/verify" method="post">
                      @csrf
                      <button class="btn btn-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" type="submit">Batalkan Verifikasi</button>
                    </form>
                  @else
                    <button class="btn btn-danger btn-sm btn-deny" data-bs-toggle="modal" data-bs-target="#reasonModal" data-id="{{ $p->id }}">Tolak</button>
                    <form class="d-inline" action="/pikr/{{ $p->id }}/verify" method="post">
                      @csrf
                      <button class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" type="submit">Setuju</button>
                    </form>
                  @endif
                </td>
              </tr>
...
@section('modals')
  <div class="modal fade text-left" id="showModal" aria-labelledby="" aria-hidden="true" tabindex="-1" style="display: none;">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="showModalLabel">
            Detail Data Pencatatan
          </h5>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="basis" type="text" value="" disabled>
          </div>
          <div class="form-group">
            <label for="pengelola">Pengelola PIK-R</label>
            <input class="form-control" id="pengelola" type="text" value="" disabled>
          </div>
          <div class="form-group">
            <label for="alamat">Alamat PIK-R</label>
            <input class="form-control" id="alamat" type="text" value="" disabled>
          </div>
          <div class="form-group">
            <label for="kecamatan">Kecamatan PIK-R</label>
            <input class="form-control" id="kecamatan" type="text" value="" disabled>
          </div>
          <div class="form-group">
            <label for="desa">Desa PIK-R</label>
            <input class="form-control" id="desa" type="text" value="" disabled>
          </div>
        </div>
