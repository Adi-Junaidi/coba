...
@section('content')
    <section class="row">
        ...
        <div class="mb-5 p-4 bg-white shadow-sm">
            <form action="/up/register/artikel" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input class="form-control" id="slug" name="slug" type="text" value="{{ old('slug') }}" placeholder="Field ini otomatis terisi" readonly>
                    </div>
                </div>
