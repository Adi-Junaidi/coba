            ...
            <div class="card-body py-4-5 px-3">
              <div class="row">
                ...
                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                  ...
                  <h4 class="mb-0 font-extrabold">{{ $pembina->count() }}</h4>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body py-4-5 px-3">
              <div class="row">
                ...
                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                  ...
                  <h4 class="mb-0 font-extrabold">183.000</h4>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body py-4-5 px-3">
              <div class="row">
                ...
                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                  ...
                  <h4 class="mb-0 font-extrabold">80.000</h4>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body py-4-5 px-3">
              <div class="row">
                ...
                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                  ...
                  <h4 class="mb-0 font-extrabold">112</h4>
                </div>
              </div>
            </div>
          </div>
