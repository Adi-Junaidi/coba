        ...
        <div class="row g-2 mb-3">
          <div class="col-md">
            <div class="d-flex justify-content-end">
              <a class="btn btn-primary" href="/pikr/create"><span class="fa-fw fas me-2 select-all"></span>Tambah Data PIK-R</a>
            </div>
          </div>
        </div>
          ...
          <div class="modal-footer d-flex justify-content-between">
            <div>
              <button class="btn btn-info" data-bs-target="#modal1" data-bs-toggle="modal" type="button">
                <i class="bx bx-x d-block d-sm-none"></i>
                <span class="d-none d-sm-block"><span class="fa-fw fas select-all"></span> Sebelumnya</span>
              </button>
            </div>
