@extends('layouts.main', [
    'title' => "Detail Pelaporan {$pikr->nama}",
    'heading' => "Detail Pelaporan {$pikr->nama}",
    'breadcrumb' => ['Data Pelaporan', 'Detail Pelaporan'],
])
...
@section('container')
  <section>
    <a class="btn btn-sm btn-primary my-2 mx-2" href="/registrasi-kegiatan">Kembali</a>
    <div class="card">
      <div class="card-body">
