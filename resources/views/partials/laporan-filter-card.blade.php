  ...
  <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-6">
        ...
        <a class="btn btn-danger" href="{{ $downloadLinks["pdf"] }}"><i class="far fa-file-pdf"></i> Cetak</a>
        <a class="btn btn-success" href="{{ $downloadLinks["xlsx"] }}"><i class="far fa-file-excel"></i> Cetak</a>
      </div>
    </div>
  </div>
</div>
