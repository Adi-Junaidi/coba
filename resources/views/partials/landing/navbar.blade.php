  ...
  <div class="container">
    ...
    <div class="navbar-collapse collapse" id="navbar">
      <div class="navbar-nav">
        <a class="nav-link d-inline-flex align-items-center gap-2" href="/home"><i class="bi bi-house-fill d-flex align-items-center"></i>Home</a>
        <a class="nav-link d-inline-flex align-items-center gap-2" href="/articles"><i class="bi bi-newspaper d-flex align-items-center"></i>Artikel</a>
        <a class="nav-link d-inline-flex align-items-center gap-2" href="/leaderboard"><i class="bi bi-list-ol d-flex align-items-center"></i>Pemeringkatan</a>
      </div>
