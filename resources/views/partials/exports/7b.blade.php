<table style="empty-cells: show; min-width: 100%; border-collapse: collapse; background-color: white;" cellpadding="0" cellspacing="0" border="0">
  <thead>
    <tr style="height:46px" valign="top">
      <td style="white-space: nowrap; text-indent: 0px;  vertical-align: middle;text-align: center;" colspan="14">
        <span style="font-family: 'DejaVu Sans', Arial, Helvetica, sans-serif; color: #000000; font-size: 16px; line-height: 1.1640625; font-weight: bold;">JUMLAH REMAJA HADIR KONSELING PADA<br>PUSAT INFORMASI DAN KONSELING REMAJA DAN MAHASISWA (PIK REMAJA)</span>
      </td>
    </tr>
    <tr style="height:26px" valign="top">
      <td style="white-space: nowrap; text-indent: 0px;  vertical-align: middle;text-align: center;" colspan="14">
        <span style="font-family: 'DejaVu Sans', Arial, Helvetica, sans-serif; color: #000000; font-size: 16px; line-height: 1.1640625; font-weight: bold;">BULAN: {{ strtoupper($month) }} - {{ $filters['tahun'] }}</span>
      </td>
    </tr>
    <tr style="height:26px" valign="top">
  ...
  <tbody>
    ...
    @foreach ($kabkotas as $kabkota)
      @php
        $laporans = $kabkota->pikrs->flatMap(fn($pikr) => $pikr->verified_laporans)->filter(fn($laporan) => $laporan->bulan_lapor === $filters['bulan']);
