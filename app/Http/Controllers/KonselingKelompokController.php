...
class KonselingKelompokController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    $rules = [
      ...
      'kel3_kk' => 'required',
      'materi_kk' => 'required',
      'dokumentasi_konseling_kelompok' => 'required|image|file|max:1024'
    ];
    ...
    $storeData = [
      ...
      'dokumentasi' => $request->file('dokumentasi_konseling_kelompok')->store('dokumentasi/konseling_kelompok')
    ];
